...
public class UserMeBean extends BaseBean {
    ...
    public static class DataBean {
        /**
         * auth : {"click":"go-c1","level":0,"status":-1,"type":"C"}
         * notice : {"title":"测试APP"}
         ...
         * user : {"capital_status":0,"countrycode":"86","email":"","exchange_verify":0,"google_authenticator_status":0,"invite_code":"EZLLLV","mobile":"15101650501","mobile_authenticator_status":1,"uid":147776,"username":"卓越君王"}
         */
