...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.highlight.BarHighlighter;
...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.renderer.BarChartRenderer;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.renderer.XAxisRendererBarChart;
...
public class BarChart extends BarLineChartBase<BarData> implements BarDataProvider {
	...
	/**
	 * if set to true, StatementEntity grey area is drawn behind each bar that indicates the maximum value
	 */
	...
	protected void calcMinMax() {
		...
		// increase deltax by 1 because the bars have StatementEntity width of 1
	...
	/**
	 * If set to true, StatementEntity grey area is drawn behind each bar that indicates the maximum value. Enabling his will reduce
