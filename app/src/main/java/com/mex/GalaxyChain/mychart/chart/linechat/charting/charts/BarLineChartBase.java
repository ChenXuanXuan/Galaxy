...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.data.BarEntry;
...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.jobs.AnimatedMoveViewJob;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.jobs.AnimatedZoomJob;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.jobs.MoveViewJob;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.jobs.ZoomJob;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.listener.BarLineChartTouchListener;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.listener.OnDrawListener;
...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.utils.PointD;
...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>
    ...
    /**
     * flag that indicates if highlighting per dragging over StatementEntity fully zoomed out
     * chart is enabled
     */
    ...
    /**
     * flag indicating if the chart should stay at the same position after StatementEntity rotation. Default is false.
     */
     ...
     *
     * @param yValue
     * @param axis   - which axis should be used as StatementEntity reference for the y-axis
     */
    ...
    /**
     * flag that indicates if StatementEntity custom viewport offset has been set
     */
    ...
    /**
     * Sets whether the chart should keep its position (zoom / scroll) after StatementEntity rotation (orientation change)
     */
     ...
     * (encapsulated in StatementEntity PointD). This method transforms pixel coordinates to
     ...
     * StatementEntity value contained in one of the datasets)
     *
     * @param x
     * @param y
     * @return
    ...
    /**
     * Sets StatementEntity custom XAxisRenderer and overrides the existing (default) one.
     *
     * @param xAxisRenderer
     */
    ...
    /**
     * Sets StatementEntity custom axis renderer for the left axis and overwrites the existing one.
     *
    ...
    /**
     * Sets StatementEntity custom axis renderer for the right acis and overwrites the existing one.
     *
