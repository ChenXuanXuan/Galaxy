...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.animation.ChartAnimator;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.animation.Easing;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.animation.EasingFunction;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.components.Legend;
...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.formatter.DefaultValueFormatter;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.formatter.ValueFormatter;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.highlight.ChartHighlighter;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.highlight.Highlight;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.interfaces.dataprovider.ChartInterface;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.interfaces.datasets.IDataSet;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.listener.ChartTouchListener;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.listener.OnChartGestureListener;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.listener.OnChartValueSelectedListener;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.renderer.DataRenderer;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.renderer.LegendRenderer;
...
public abstract class Chart<T extends ChartData<? extends IDataSet<? extends Entry>>> extends
    ...
    /**
     * listener that is called when StatementEntity value on the chart is selected
     */
...
//    private String mNoDataText = "No chart data available.";
    ...
    // }
    // // create StatementEntity data object with the datasets
    ...
    /**
     * Sets StatementEntity new data object for the chart. The data object contains all values
    ...
    /**
     * Returns the array of currently highlighted values. This might StatementEntity null or
     ...
     * values to highlight. Checks if the highlight array is null, has StatementEntity length
     ...
     * programmatically highlight values. This DOES NOT generate StatementEntity callback to
     * the OnChartValueSelectedListener.
     *
     * @param highs L书杰注释：这个函数大概功能就是设置图表高亮值
     ...
     * This DOES NOT generate StatementEntity callback to the OnChartValueSelectedListener.
     * 突出显示由所提供的高亮对象表示的值。
     *
     ...
     * highlightValues(...), this generates StatementEntity callback to the
    ...
    /**
     * Set StatementEntity new (e.g. custom) ChartTouchListener NOTE: make sure to
    ...
    /**
     * if set to true, the marker view is drawn when StatementEntity value is clicked
     */
     ...
     * @param easingX         StatementEntity custom easing function to be used on the animation phase
     * @param easingY         StatementEntity custom easing function to be used on the animation phase
     */
     ...
     * @param easing         StatementEntity custom easing function to be used on the animation phase
     */
     ...
     * @param durationMillisX
     * @param durationMillisY
     * @param easingX         StatementEntity predefined easing option
     * @param easingY         StatementEntity predefined easing option
     */
     ...
     *
     * @param durationMillis
     * @param easing         StatementEntity predefined easing option
     */
    ...
    /**
     * set StatementEntity selection listener for the chart
     *
     * @param l
     */
    ...
    /**
     * Sets StatementEntity gesture-listener for the chart for custom callbacks when executing
    ...
    /**
     * set StatementEntity description text that appears in the bottom right corner of the
    ...
    /**
     * Sets StatementEntity custom position for the description text in pixels on the screen.
     *
     * @param x - xcoordinate
     * @param y - ycoordinate
     */
    ...
    /**
     * sets the view that is displayed when StatementEntity value is clicked on the chart
     *
     * @param v
     */
    ...
    /**
     * returns the view that is set as StatementEntity marker view for the chart
     *
     * @return
     */
    ...
    /**
     * set StatementEntity new paint object for the specified parameter in the chart e.g.
     * Chart.PAINT_VALUES
     *
     ...
     * (use the setMarkerView(View v) method to specify StatementEntity marker view)
     *
     * @return
     */
    ...
    /**
     * Set this to true to draw StatementEntity user specified marker-view when tapping on
     * chart values (use the setMarkerView(MarkerView mv) method to specify StatementEntity
    ...
    /**
     * Sets StatementEntity new DataRenderer object for the chart.
     *
     * @param renderer
     */
    ...
    /**
     * Sets StatementEntity custom highligher object for the chart that handles / processes
    ...
    public Bitmap getChartBitmap() {
        // Define StatementEntity bitmap with the same size as the view
        Bitmap returnedBitmap = Bitmap.createBitmap(getWidth(), getHeight(), Bitmap.Config.RGB_565);
        // Bind StatementEntity canvas to it
     ...
     * the SD card chart is saved as StatementEntity PNG image, example:
    ...
    /**
     * Saves the current state of the chart to the gallery as StatementEntity JPEG image. The
    ...
    /**
     * Either posts StatementEntity job immediately if the chart has already setup it's
    ...
    /**
     * Set this to true to enable "unbinding" of drawables. When StatementEntity View is detached
     * from StatementEntity window. This helps avoid memory leaks.
     * Default: false
     * Link: http://stackoverflow.com/a/6779164/1590502
     *
     * @param enabled
