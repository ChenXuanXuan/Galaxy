...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.renderer.PieChartRenderer;
...
/**
 * View that represents StatementEntity pie chart. Draws cake like slices.
 *
...
public class PieChart extends PieRadarChartBase<PieData> {
    ...
    /**
     * calculates the needed angle for StatementEntity given value
     *
     * @param value
     * @return
     */
    ...
    /**
     * Returns true if the chart is set to draw each end of StatementEntity pie-slice
     * "rounded".
     *
     * @return
     */
    ...
    /**
     * the rectangular radius of the bounding box for the center text, as StatementEntity percentage of the pie
     * hole
     * default 1.f (100%)
     */
     ...
     * it's StatementEntity full PieChart, 180f results in StatementEntity half-pie-chart. Default: 360f
     *
