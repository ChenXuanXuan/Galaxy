...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.listener.PieRadarChartTouchListener;
...
public abstract class PieRadarChartBase<T extends ChartData<? extends IDataSet<? extends Entry>>>
    ...
    /**
     * Returns the distance of StatementEntity certain point on the chart to the center of the
     * chart.
     *
     * @param x
     * @param y
    ...
    /**
     * gets StatementEntity normalized version of the current rotation angle of the pie chart,
    ...
    /**
     * Applys StatementEntity spin animation to the Chart.
     * 
