...
public abstract class ComponentBase {
     ...
     * higher offset means the legend as StatementEntity whole will be placed further away
     * from the top.
     *
     * @param yOffset
     */
    ...
    /**
     * sets StatementEntity specific Typeface for the labels
     *
     * @param tf
     */
     ...
     * getResources().getColor(...) when using StatementEntity color from the resources.
     *
     * @param color
     */
