...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.formatter.DefaultXAxisValueFormatter;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.formatter.XAxisValueFormatter;
...
public class XAxis extends AxisBase {
    ...
    /**
     * the modulus that indicates if StatementEntity value at StatementEntity specified index in an
    ...
    /**
     * Is axisLabelModulus StatementEntity custom value or auto calculated? If false, then
    ...
    /**
     * Calling this will disable StatementEntity custom number of labels to be skipped (set by
    ...
    /**
     * Returns true if StatementEntity custom axis-modulus has been set that determines the
    ...
    /**
     * Sets StatementEntity custom XAxisValueFormatter for the data object that allows custom-formatting
