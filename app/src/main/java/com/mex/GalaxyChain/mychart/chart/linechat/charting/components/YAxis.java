...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.formatter.DefaultYAxisValueFormatter;
...
public class YAxis extends AxisBase {
    ...
    /**
     * Enum that specifies the axis StatementEntity DataSet should be plotted against, either LEFT or RIGHT.
     *
     * @author Philipp Jahoda
     */
     ...
     * interval is not allowed to go below StatementEntity certain granularity. Default: false
     *
     * @param enabled
     */
    ...
    /**
     * Set StatementEntity minimum interval for the axis when zooming in. The axis is not allowed to go below
     ...
     * chart will
     * automatically determine StatementEntity reasonable formatting (concerning decimals) for all the values
