...
public class BarData extends BarLineScatterCandleBubbleData<IBarDataSet> {
    ...
    // /**
    // * The maximum space (in pixels on the screen) StatementEntity single bar can consume.
    // */
    ...
    //
    // /**
    // * Sets the maximum width (in density pixels) StatementEntity single bar in the barchart
    // * should consume.
    // *
    // * @param max
    // */
    ...
    //
    // /**
    // * Returns the maximum width (in density pixels) StatementEntity single bar in the
