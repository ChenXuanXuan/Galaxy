...
public class BarEntry extends Entry {
	...
	/**
	 * Returns the stacked values this BarEntry represents, or null, if only StatementEntity single value is represented (then, use
	 * getVal()).
	 * 
	 * @return
	 */
	...
	/**
	 * Returns true if this BarEntry is stacked (has StatementEntity values array), false if not.
	 * 
	 * @return
	 */
	...
	/**
	 * Returns the sum of all negative values this entry (if stacked) contains. (this is StatementEntity positive number)
	 * 
	 * @return
	 */
