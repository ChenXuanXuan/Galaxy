...
public abstract class BaseDataSet<T extends Entry> implements IDataSet<T> {
    ...
    /**
     * Adds StatementEntity new color to the colors array of the DataSet.
     *
     * @param color
     */
    ...
    /**
     * Sets StatementEntity color with StatementEntity specific alpha value.
     *
     * @param color
    ...
    /**
     * Sets colors with StatementEntity specific alpha value.
     *
     * @param colors
     * @param alpha
     */
