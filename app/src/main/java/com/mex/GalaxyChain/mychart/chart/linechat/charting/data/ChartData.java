...
public abstract class ChartData<T extends IDataSet<? extends Entry>> {
    ...
    /**
     * Adds StatementEntity new x-value to the chart data.
     *
     * @param xVal
     */
    ...
    /**
     * Retrieve the index of StatementEntity DataSet with StatementEntity specific label from the ChartData.
    ...
    /**
     * Returns the labels of all DataSets as StatementEntity string array.
     *
     * @return
     */
    ...
    /**
     * Get the Entry for StatementEntity corresponding highlight object
     *
     * @param highlight
    ...
    public Entry getEntryForHighlight(Highlight highlight) {
        if (highlight.getDataSetIndex() >= mDataSets.size())
            ...
            //   if we are not interested in highlighting StatementEntity specific value.
    ...
    /**
     * Adds StatementEntity DataSet dynamically.
     *
     * @param d
     */
     ...
     * minimum and maximum values. Returns true if StatementEntity DataSet was removed, false
    ...
    public boolean removeDataSet(T d) {
        ...
        // if StatementEntity DataSet was removed
        if (removed) {
     ...
     * StatementEntity DataSet was removed, false if no DataSet could be removed.
     *
     * @param index
     */
    ...
    /**
     * Sets StatementEntity custom ValueFormatter for all DataSets this data object contains.
     *
     * @param f
     */
