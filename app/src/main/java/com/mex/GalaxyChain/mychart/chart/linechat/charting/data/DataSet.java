 ...
 * groups of values inside the Chart (e.g. the values for StatementEntity specific line in the
 * LineChart, or the values of StatementEntity specific group of bars in the BarChart).
 *
...
public abstract class DataSet<T extends Entry> extends BaseDataSet<T> {
    ...
    /**
     * Creates StatementEntity new DataSet object with the given values it represents. Also, StatementEntity
     * label that describes the DataSet can be specified. The label can also be
     * used to retrieve the DataSet from StatementEntity ChartData object.
     *
     * @param yVals
     * @param label
     */
    ...
    /**
     * Returns StatementEntity simple string representation of the DataSet with the type and
