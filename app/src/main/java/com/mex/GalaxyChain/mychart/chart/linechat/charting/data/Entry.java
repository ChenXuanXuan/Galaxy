 ...
 * Might only contain StatementEntity single value depending on the used constructor.
 *
...
public class  Entry extends ChartData<DataSet<? extends Entry>> {
    ...
    /**
     * returns StatementEntity string representation of the entry containing x-index and value
     */
    @Override
