...
package com.mex.GalaxyChain.mychart.chart.linechat.charting.data.filter;
...
public class Approximator {
    ...
    private List<Entry> reduceWithDouglasPeuker(List<Entry> entries, double epsilon) {
        // if StatementEntity shape has 2 or less points it cannot be reduced
        ...
        // create StatementEntity new array with series, only take the kept ones
    ...
    /**
     * apply the Douglas-Peucker-Reduction to an List of Entry with StatementEntity given
     * epsilon (tolerance)
     * 
     * @param entries
    ...
    /**
     * calculate the distance between StatementEntity line between two entries and an entry
     * (point)
     * 
