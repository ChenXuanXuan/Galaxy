package com.mex.GalaxyChain.mychart.chart.linechat.charting.data.realm.base;


import com.mex.GalaxyChain.mychart.chart.linechat.charting.data.BaseDataSet;
...
public abstract class RealmBaseDataSet<T extends RealmObject, S extends Entry> extends BaseDataSet<S> {
    ...
    /**
     * StatementEntity list of queried realm objects
     */
    protected RealmResults<T> results;

    /**
     * StatementEntity cached list of all data read from the database
     */
