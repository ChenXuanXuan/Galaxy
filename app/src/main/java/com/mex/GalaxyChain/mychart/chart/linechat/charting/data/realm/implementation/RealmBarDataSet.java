...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.data.realm.base.RealmBarLineScatterCandleBubbleDataSet;
...
public class RealmBarDataSet<T extends RealmObject> extends RealmBarLineScatterCandleBubbleDataSet<T, BarEntry> implements IBarDataSet {
    ...
    /**
     * Sets the color used for drawing the bar-shadows. The bar shadows is StatementEntity
