...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.data.realm.base.RealmLineRadarDataSet;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.formatter.DefaultFillFormatter;
...
public class RealmLineDataSet<T extends RealmObject> extends RealmLineRadarDataSet<T> implements ILineDataSet {
    ...
    /**
     * Constructor for creating StatementEntity LineDataSet with realm data.
     *
    ...
    /**
     * resets the circle-colors array and creates StatementEntity new one
     */
    ...
    /**
     * Set this to true to allow drawing StatementEntity hole in each data circle.
     *
     * @param enabled
     */
    ...
    /**
     * Sets StatementEntity custom FillFormatter to the chart that handles the position of the
