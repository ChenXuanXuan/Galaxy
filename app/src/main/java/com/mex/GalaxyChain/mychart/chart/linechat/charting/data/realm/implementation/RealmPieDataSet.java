...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.data.realm.base.RealmBaseDataSet;
...
public class RealmPieDataSet<T extends RealmObject> extends RealmBaseDataSet<T, Entry> implements IPieDataSet {
    ...
    /**
     * indicates the selection distance of StatementEntity pie slice
     */
    ...
    /**
     * Constructor for creating StatementEntity PieDataSet with realm data.
     *
