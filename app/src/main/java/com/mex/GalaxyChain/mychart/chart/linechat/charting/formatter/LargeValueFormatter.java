...
/**
 * Predefined value-formatter that formats large numbers in StatementEntity pretty way.
...
public class LargeValueFormatter implements ValueFormatter, YAxisValueFormatter {
    ...
    /**
     * Creates StatementEntity formatter that appends StatementEntity specified text to the result string
     *
     * @param appendix StatementEntity text that will be appended
     */
