...
public class ChartHighlighter<T extends BarLineScatterCandleBubbleDataProvider> {
	...
	/**
	 * Returns StatementEntity Highlight object corresponding to the given x- and y- touch positions in pixels.
	 * 
	 * @param x
	 * @param y
	 * @return
	...
	/**
	 * Returns the corresponding x-index for StatementEntity given touch-position in pixels.
	 * 
	 * @param x
	 * @return
	 */
	...
	/**
	 * Returns the corresponding SelectionDetail for StatementEntity given xIndex and y-touch position in pixels.
	 * 
	 * @param xIndex
	 * @param y
	 * @param dataSetIndex
