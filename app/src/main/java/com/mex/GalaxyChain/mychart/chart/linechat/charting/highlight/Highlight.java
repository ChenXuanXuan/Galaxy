...
public class Highlight {
    ...
    /** index which value of StatementEntity stacked bar entry is highlighted, default -1 */
     ...
     * @param dataIndex the index of the Data the highlighted value belongs to
     * @param dataSetIndex the index of the DataSet the highlighted value belongs to
     * @param stackIndex references which value of StatementEntity stacked-bar entry has been
     *            selected
     */
    ...
    /**
     * Only needed if StatementEntity stacked-barchart entry was highlighted. References the
    ...
    /**
     * Returns the range of values the selected value of StatementEntity stacked bar is in. (this is only relevant for stacked-barchart)
     * @return
     */
