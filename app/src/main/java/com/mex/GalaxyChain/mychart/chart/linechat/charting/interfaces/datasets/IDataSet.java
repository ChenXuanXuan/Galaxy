...
public interface IDataSet<T extends Entry> {
     ...
     * index in the Entry array of the DataSet for StatementEntity given xIndex. IMPORTANT: This method does
     ...
     * no formatter is set, the chart will automatically determine StatementEntity reasonable
    ...
    /**
     * Sets StatementEntity list of colors to be used as the colors for the drawn values.
     *
     * @param colors
     */
    ...
    /**
     * Sets StatementEntity Typeface for the value-labels of this DataSet.
     *
     * @param tf
     */
