...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.charts.HorizontalBarChart;
...
public class BarLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>> {
    ...
    /**
     * the distance of movement that will be counted as StatementEntity drag
     */
    private float mDragTriggerDist;

    /**
     * the minimum distance between the pointers that will trigger StatementEntity zoom gesture
     */
    ...
    public BarLineChartTouchListener(BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> chart, Matrix touchMatrix) {
        ...
        // this equals to about 9 pixels on StatementEntity 5.5" FHD screen
...
//        com.taojinyn.news.account.chart.linechat.charting.highlight.Highlight h = mChart.getHighlightByTouchPoint(e.getX(), e.getY());
      //  com.td.taojinyn.activity.mychart.chart.linechat.charting.highlight.Highlight h = mChart.getHighlightByTouchPoint(e.getX(), e.getY());
        com.mex.GalaxyChain.mychart.chart.linechat.charting.highlight.Highlight h = mChart.getHighlightByTouchPoint(e.getX(), e.getY());
