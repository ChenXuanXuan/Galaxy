...
public interface OnChartGestureListener {
    ...
    /**
     * Callbacks when StatementEntity touch-gesture has started on the chart (ACTION_DOWN)
     *
     * @param me
    ...
    /**
     * Callbacks when StatementEntity touch-gesture has ended on the chart (ACTION_UP, ACTION_CANCEL)
     *
     * @param me
     * @param lastPerformedGesture
     */
    ...
    /**
     * Callbacks then StatementEntity fling gesture is made on the chart.
     *
     * @param me1
     * @param me2
     * @param velocityX
