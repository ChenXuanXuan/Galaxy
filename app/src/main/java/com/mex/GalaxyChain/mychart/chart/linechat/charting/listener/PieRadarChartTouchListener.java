...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.charts.PieChart;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.charts.PieRadarChartBase;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.charts.RadarChart;
...
public class PieRadarChartTouchListener extends ChartTouchListener<PieRadarChartBase<?>> {
    ...
    public boolean onSingleTapUp(MotionEvent e) {
        ...
        // check if StatementEntity slice was touched
    ...
    private float calculateVelocity() {
        ...
        // Look for StatementEntity sample that's closest to the latest sample, but not the same, so we can deduce the direction
        ...
        // Now if the "gesture" is over StatementEntity too big of an angle - then we know the angles are inverted, and we need to move them closer to each other from both sides of the 360.0 wrapping point
