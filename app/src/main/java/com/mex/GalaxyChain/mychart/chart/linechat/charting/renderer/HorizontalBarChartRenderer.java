...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.buffer.BarBuffer;
import com.mex.GalaxyChain.mychart.chart.linechat.charting.buffer.HorizontalBarBuffer;
        ...
        if (passesCheck()) {
            ...
            for (int i = 0; i < mChart.getBarData().getDataSetCount(); i++) {
                ...
                if (!dataSet.isStacked()) {
                    ...
                    // if each value of StatementEntity potential stack should be drawn
                } else {
