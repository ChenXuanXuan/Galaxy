...
package com.mex.GalaxyChain.mychart.chart.linechat.charting.renderer;
    ...
    public void computeLegend(ChartData<?> data) {
        ...
        if (!mLegend.isLegendCustom()) {
            ...
            for (int i = 0; i < data.getDataSetCount(); i++) {
                ...
                // if we have StatementEntity barchart with stacked bars
                if (dataSet instanceof IBarDataSet && ((IBarDataSet) dataSet).isStacked()) {
                    ...
                    for (int j = 0; j < clrs.size() && j < entryCount; j++) {
                        ...
                        // if multiple colors are set for StatementEntity DataSet, group them
    ...
    public void renderLegend(Canvas c) {
        ...
        switch (horizontalAlignment) {
            ...
            case CENTER:
                ...
                // Horizontally layed out legends do the center offset on StatementEntity line basis,
            ...
            case VERTICAL: {
                ...
                for (int i = 0; i < labels.length; i++) {
                    ...
                    if (labels[i] != null) {
                        ...
                        // make StatementEntity step down
                        posY += labelLineHeight + labelLineSpacing;
                        stack = 0f;
                    } else {
