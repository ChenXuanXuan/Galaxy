...
public class LineChartRenderer extends LineRadarRenderer {
    ...
    /**
     * Draws StatementEntity cubic line.
     *
     * @param c
     * @param dataSet
     */
    protected void drawHorizontalBezier(Canvas c, ILineDataSet dataSet) {
        ...
        if (dataSet.isDrawFilledEnabled()) {
            ...
            // create StatementEntity new path, this is bad for performance
    ...
    /**
     * Draws StatementEntity normal line.
     *
     *画一个虚线
     *
     * @param c
        ...
        if (dataSet.getColors().size() > 1) {
            ...
            for (int j = minx;
                ...
                if (count > 1 && j == count - 1) {
                    // Last point, we have already drawn StatementEntity line to this point
                    break;
                }
    ...
    private Path generateFilledPath(ILineDataSet dataSet, int from, int to) {
        ...
        // create StatementEntity new path
