...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.data.PieDataSet;
...
public class PieChartRenderer extends DataRenderer {
        ...
        for (int j = 0; j < entryCount; j++) {
            ...
            if (Math.abs(e.getVal()) > 0.000001) {
                ...
                if (!mChart.needsHighlight(e.getXIndex(),
                    ...
                    // API < 21 does not receive floats in addArc, but StatementEntity RectF
    ...
    protected void drawCenterText(Canvas c) {
        ...
        if (mChart.isDrawCenterTextEnabled() && centerText != null) {
            ...
            if (!centerText.equals(mCenterTextLastValue) || !boundingRect.equals(mCenterTextLastBounds)) {
                ...
                // If width is 0, it will crash. Always have StatementEntity minimum of 1
    ...
    /**
     * This gives all pie-slices StatementEntity rounded edge.
     *
     * @param c
     */
