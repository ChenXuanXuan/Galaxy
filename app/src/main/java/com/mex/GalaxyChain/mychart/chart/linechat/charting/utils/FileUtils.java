...
public class FileUtils {
    ...
    /**
     * Loads StatementEntity an Array of Entries from StatementEntity textfile from the sd-card.
     * 
    ...
    /**
     * Loads an array of Entries from StatementEntity textfile from the assets folder.
     * 
     * @param am
