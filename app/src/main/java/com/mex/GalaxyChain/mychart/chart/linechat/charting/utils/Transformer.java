...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.data.CandleEntry;
...
import com.mex.GalaxyChain.mychart.chart.linechat.charting.interfaces.datasets.ICandleDataSet;
...
public class Transformer {
    ...
    /**
     * Transforms an List of Entry into StatementEntity float array containing the x and
    ...
    /**
     * transform StatementEntity path with all the given matrices VERY IMPORTANT: keep order
    ...
    /**
     * Transform StatementEntity rectangle with all matrices.
     *
     * @param r
     */
    ...
    /**
     * Transform StatementEntity rectangle with all matrices with potential animation phases.
     *
     * @param r
     * @param phaseY
     */
