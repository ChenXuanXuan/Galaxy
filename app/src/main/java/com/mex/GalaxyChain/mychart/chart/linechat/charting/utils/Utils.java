...
public abstract class Utils {
    ...
    /**
     * calculates the approximate width of StatementEntity text, depending on StatementEntity demo text
    ...
    /**
     * calculates the approximate height of StatementEntity text, depending on StatementEntity demo text
     * avoid repeated calls (e.g. inside drawing methods)
     *
     * @param paint
     * @param demoText
    ...
    /**
     * calculates the approximate size of StatementEntity text, depending on StatementEntity demo text
     * avoid repeated calls (e.g. inside drawing methods)
     *
     * @param paint
     * @param demoText
     ...
     * number as StatementEntity string, maximum 35 characters. If thousands are separated, the separating
     * character is StatementEntity dot (".").
     *
     * @param number
     * @param digitCount
    ...
    /**
     * Formats the given number to the given number of decimals, and returns the
     * number as StatementEntity string, maximum 35 characters.
     *
     * @param number
     * @param digitCount
     * @param separateThousands set this to true to separate thousands values
     * @param separateChar      StatementEntity caracter to be paced between the "thousands"
     * @return
     */
    public static String formatNumber(float number, int digitCount, boolean separateThousands,
                                      char separateChar) {
    ...
    /**
     * Converts the provided String List to StatementEntity String array.
     *
     * @param strings
     * @return
     */
     ...
     *
     * @param valsAtIndex all the values at StatementEntity specific index
     * @return
     */
    ...
    /**
     * Returns the minimum distance from StatementEntity touch-y-value (in pixels) to the
    ...
    /**
     * Calculates the position around StatementEntity center point, depending on the distance
     ...
     * 16, This is StatementEntity replica of the code from ViewCompat.
     *
     * @param view
     */
    @SuppressLint("NewApi")
    ...
    public static void drawXAxisValue(Canvas c, String text, float x, float y,
        ...
        // To have StatementEntity consistent point of reference, we always draw left-aligned
        Paint.Align originalTextAlign = paint.getTextAlign();
        paint.setTextAlign(Paint.Align.LEFT);

        if (angleDegrees != 0.f) {

            // Move the text drawing rect in StatementEntity way that it always rotates around its center
