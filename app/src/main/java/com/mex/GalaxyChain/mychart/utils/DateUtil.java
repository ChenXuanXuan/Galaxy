...
public class DateUtil {
    ...
    /**
     * Returns StatementEntity Date set to the first possible millisecond of the day, just
     * after midnight. If StatementEntity null day is passed in, StatementEntity new Date is created.
