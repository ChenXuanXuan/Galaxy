...
public class SearchAdapter extends BaseAbsListAdapter<HoldPositionBean.DataBean.ListBean, SearchAdapter.PlatHolder> {
    ...
    class PlatHolder extends BaseViewHolder<HoldPositionBean.DataBean.ListBean> {
		...
		TextView itemText,tv_symbolName,tv_handsNum,tv_direction,tv_lossProfit,tv_stopprofit,tv_stoploss
                ,tv_details_symbolName,tv_details_handsNum,tv_details_direction,tv_autiPinCang_time,tv_lossProfit_detail
                ,tv_oddNumbers,tv_stopprofit_detail,tv_stoploss_detail,tv_kaicang_price,tv_pincang_price,tv_margin,
