                ...
                .subscribe(new Subscriber<GoodsPriceBean>() {
                    ...
                    public void onNext(GoodsPriceBean goodsPriceBean) {
                        if (goodsPriceBean.getCode() == 200) {
                            ...
                            List<GoodsPriceBean.DataBean> mDataBeanList = goodsPriceBean.getData();
                            if (mDataBeanList == null || mDataBeanList.size() == 0) return;
                            goodsPriceList.clear();
                            goodsPriceList.addAll(mDataBeanList);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (mSymbolInfosBeanList != null && mSymbolInfosBeanList.size() > 0) {
                    ...
                    UserGolbal.getInstance().setTag(all_variety);//全部品种
                    ...
                    UIHelper.toKLineActivity(getActivity());
                }
