...
import com.mex.GalaxyChain.ui.activity.RefreshActivity;
import com.mex.GalaxyChain.utils.webUtils.SecurityJsBridgeBundle;
import com.mex.GalaxyChain.utils.webUtils.X5WebViewEventHandler;
    ...
    public X5WebView(Context arg0, AttributeSet arg1) {
        ...
        this.setWebChromeClient(new WebChromeClient() {
            ...
            public void onShowCustomView(View view,
                ...
                FrameLayout normalView = (FrameLayout) findViewById(R.id.mWebView);
                ViewGroup viewGroup = (ViewGroup) normalView.getParent();
                viewGroup.removeView(normalView);
                viewGroup.addView(view);
                myVideoView = view;
        ...
        this.setDownloadListener(new DownloadListener() {
            ...
            public void onDownloadStart(String arg0, String arg1, String arg2,
                ...
                new AlertDialog.Builder(MyApplication.appContext)
