...
import com.lsj.kchart.kchartlib.chart.entity.VolImpl;
import com.lsj.kchart.kchartlib.chart.base.IChartDraw;
import com.lsj.kchart.kchartlib.chart.base.IValueFormatter;
import com.lsj.kchart.kchartlib.chart.formatter.BigValueFormatter;
import com.lsj.kchart.kchartlib.utils.ViewUtil;

/**
 * Created by hjm on 2017/11/14 17:49.
 */

public class VolumeDraw implements IChartDraw<VolImpl> {
    ...
    public void drawTranslated(
            @Nullable VolImpl lastPoint, @NonNull VolImpl curPoint, float lastX, float curX,
    ...
    private void drawHistogram(
            Canvas canvas, VolImpl curPoint, VolImpl lastPoint, float curX,
